...
--INSERT INTO options.met_princ_ma (name_key, code_key, pt, en, text_replace)
...
INSERT INTO options.met_princ_ma (name_key, code_key, pt, en)
...
ARRAY['Cercamento', 'Fencing', 'cercamento/isolamento da área cercamento', 'cercamento/isolamento da área','Regeneração natural sem manejo', 'Natural Regeneration without Management']);
