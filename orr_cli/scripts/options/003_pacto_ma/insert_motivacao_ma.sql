...
--INSERT INTO options.motivacao_ma (name_key, code_key, pt, en, text_replace) 
...
INSERT INTO options.motivacao_ma (name_key, code_key, pt, en) 
...
INSERT INTO options.motivacao_ma (name_key, code_key, pt, en, text_replace) 
VALUES ('motiv_comp_licensing','mot04', 'Compensação ambiental no ambito do licenciamento', 'Environmental compensation within the scope of licensing', ARRAY['area de compensacao ambiental no ambito do licenciamento']);
...
INSERT INTO options.motivacao_ma (name_key, code_key, pt, en, text_replace) 
VALUES ('motiv_obli_infraction', 'mot06','Outros atos infracionais', 'Other acts of infraction', ARRAY['atos infracionais','outros atos infracionais']);
