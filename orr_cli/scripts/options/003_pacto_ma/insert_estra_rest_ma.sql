...
--INSERT INTO options.estra_rest_ma (name_key, code_key, pt, en, text_replace) 
--VALUES ('est_rest_not_applicable', 'ers00', 'Não se aplica', 'Not applicable', ARRAY['0']);

INSERT INTO options.estra_rest_ma (name_key, code_key, pt, en, text_replace) 
VALUES ('est_rest_not_id', 'ers00', 'Não identificado', 'Not identified', ARRAY['0','Não se aplica', 'Not applicable']);

INSERT INTO options.estra_rest_ma (name_key, code_key, pt, en) 
