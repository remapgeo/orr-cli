-- DONE: retirar a opção nao se aplica
-- DONE mrs03 e mrs08 devem virar mrs13

--INSERT INTO options.met_princ (name_key, code_key, pt, en)
--VALUES ('met_rest_not_app', 'mrs00', 'Não se aplica', 'Not applicable');

INSERT INTO options.met_princ (name_key, code_key, pt, en, text_replace)
VALUES ('met_rest_not_id', 'mrs00', 'Não identificado', 'Not identified', 
...
ARRAY['Regeneração natural sem manejo','Cercamento','cercamento/isolamento da área cercamento', 'cercamento/isolamento da área']);
