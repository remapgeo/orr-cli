-- DONE retirar nao se aplica, manter nao informado

--INSERT INTO options.proj_ativo (name_key, code_key, pt, en, text_replace) 
...
INSERT INTO options.proj_ativo (name_key, code_key, pt, en) 
